...
#ifdef __STDC__
void zadd(zword_t, zword_t);
void zand(zword_t, zword_t);
void zarith_shift(zword_t, zword_t);
void zcompare_je(int, zword_t *);
void zcompare_jg(zword_t, zword_t);
void zcompare_jl(zword_t, zword_t);
void zcompare_zero(zword_t);
void zdivide(zword_t, zword_t);
void zmultiply(zword_t, zword_t);
void znot(zword_t);
void zor(zword_t, zword_t);
void zrandom(zword_t);
void zremainder(zword_t, zword_t);
void zshift(zword_t, zword_t);
void zsubtract(zword_t, zword_t);
void ztest(zword_t, zword_t);
#else
void add();
void and ();
void arith_shift();
